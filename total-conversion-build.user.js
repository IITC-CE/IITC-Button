...
window.iitcBuildDate = '2015-09-17-154202';
...
//          row += '<span class="fragments'+(data[type].target?' '+TEAM_TO_CSS[data[type].target]:'')+'">'+fragmentName+': #'+data[type].fragments.join(', #')+'</span> ';
  ...
  html += "<hr />"
        ...
        + "<xul><li>Which team each target portal is for - only that it is a target</li>"
...
var script = document.createElement('script');
var info = { buildName: 'jonatkins', dateTimeVersion: '20150917.154202' };
